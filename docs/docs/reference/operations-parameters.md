...
If you want to override global behavior, you can inherit the HattoriAPI instance and override the `get_openapi_operation_id` method.
...
## Specifying servers
If you want to specify single or multiple servers for OpenAPI specification `servers` can be used when initializing HattoriAPI instance:
```python hl_lines="4 5 6 7"
from hattori import HattoriAPI
