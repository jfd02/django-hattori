...
This response object is used for the base of all responses built by Django Hattori, including error responses. This object is *not* used if a Django `HttpResponse` object is returned directly by an operation.
...
You can alter this temporal response object by overriding the `HattoriAPI.create_temporal_response` method.
