...
**Django Hattori** takes full advantage of async views and makes it very easy to work with them.
...
Keep in mind that you can use **both sync and async operations** in your project, and **Django Hattori** will route it automatically:
