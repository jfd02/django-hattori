...
def router1_op1(request) -> str:
    return "first 2"


@second_router_one.get("endpoint_3")
# router2->router1, router1->api, view->router2
def router21_op3(request, path_param: int = None) -> str:
...
def router_op3(request, path_param: int = None) -> str:
