...
from hattori.testing import TestClient as HattoriTestClient
from tests.demo_project.multi_param.api import router

test_client = HattoriTestClient(router)
...
def test_data_round_trip_with_hattori_client(path, client_args):
    ...
    response = test_client.post(**kwargs)
