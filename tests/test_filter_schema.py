...
def test_annotated_without_filter_lookup():
    ...
    class DummyFilterSchema(FilterSchema):
        name: Annotated[str | None, "some_annotation"] = None
...
def test_improperly_configured_deprecated():
    ...
    class DummyFilterSchema(FilterSchema):
        popular: str | None = Field(None, q=Q(view_count__gt=1000))
...
def test_improperly_configured_annotated():
    ...
    class DummyFilterSchema(FilterSchema):
        popular: Annotated[str | None, FilterLookup(Q(view_count__gt=1000))] = None
...
def test_empty_q_when_none_ignored_annotated():
    ...
    class DummyFilterSchema(FilterSchema):
        ...
        tag: Annotated[str | None, FilterLookup("tag")] = None
...
def test_q_expressions2_annotated(implicit_field_name):
    ...
    class DummyFilterSchema(FilterSchema):
        name: Annotated[str | None, FilterLookup(q)] = None
        tag: Annotated[str | None, FilterLookup("tag")] = None
...
def test_q_is_a_list_deprecated(implicit_field_name):
    ...
    class DummyFilterSchema(FilterSchema):
        name: str | None = Field(None, q=[q__name, "user__username__icontains"])
        tag: str | None = Field(None, q="tag")
...
def test_q_is_a_list_annotated(implicit_field_name):
    ...
    class DummyFilterSchema(FilterSchema):
        name: Annotated[
            str | None, FilterLookup([q__name, "user__username__icontains"])
        ] = None
        tag: Annotated[str | None, FilterLookup("tag")] = None
...
def test_class_level_expression_connector_deprecated():
    ...
    class DummyFilterSchema(FilterSchema):
        tag1: str | None = Field(None, q="tag1")
        tag2: str | None = Field(None, q="tag2")
...
def test_class_level_expression_connector_annotated():
    ...
    class DummyFilterSchema(FilterSchema):
        tag1: Annotated[str | None, FilterLookup("tag1")] = None
        tag2: Annotated[str | None, FilterLookup("tag2")] = None
...
def test_ignore_none_deprecated():
    ...
    class DummyFilterSchema(FilterSchema):
        tag: str | None = Field(None, q="tag", ignore_none=False)
...
def test_class_level_custom_expression():
    ...
    class DummyFilterSchema(FilterSchema):
        adult: Annotated[bool | None, FilterLookup("this_will_be_ignored")] = None
...
def test_filter_called():
    ...
    class DummyFilterSchema(FilterSchema):
        name: Annotated[str | None, FilterLookup("name")] = None
...
def test_multiple_filter_lookup_instances_error():
    ...
    class DummyFilterSchema(FilterSchema):
        name: Annotated[
            str | None, FilterLookup("name__icontains"), FilterLookup("name__exact")
        ] = None
