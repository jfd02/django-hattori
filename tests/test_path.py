...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "/path/param-django-slug/django-hattori-is-the-best",
            200,
            "django-hattori-is-the-best",
        ),
...
def test_path_signature_asserts_default():
    ...
    with pytest.raises(AssertionError, match=match):
        ...
        def get_path_item_id(request, item_id="1") -> str:
            pass
...
def test_path_signature_warns_missing():
    ...
    with pytest.warns(UserWarning, match=match):
        ...
        def get_path_item_id(request) -> None:
            pass
